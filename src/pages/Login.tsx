  ...
  return (
    <div className="login-page">
      ...
      <div className="login-container">
        ...
        {/* Handle */}
        <div
          style={{ marginTop: 28, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, cursor: 'pointer', userSelect: 'none', WebkitUserSelect: 'none' }}
          onClick={() => setSheetOpen(true)}
          onTouchStart={e => { touchStartY.current = e.touches[0].clientY }}
          onTouchEnd={e => { if (touchStartY.current - e.changedTouches[0].clientY > 30) setSheetOpen(true) }}
        >
          <span style={{ fontSize: 11, fontWeight: 600, color: 'rgba(0,0,0,0.3)', letterSpacing: '.04em', textTransform: 'uppercase' }}>Kurzbefehle</span>
        ...
        >
          ...
          {adding && (
            <div style={{ marginTop: 12, display: 'flex', flexDirection: 'column', gap: 8 }}>
              <input style={inpSt} placeholder="Name (z.B. Lagerinventur starten)" value={newName} onChange={e => setNewName(e.target.value)} autoFocus />
              <input style={inpSt} placeholder="URL (z.B. /lager)" value={newUrl} onChange={e => setNewUrl(e.target.value)}
