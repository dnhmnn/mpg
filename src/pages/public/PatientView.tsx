...
import EinsatzTimelineReadOnly from './EinsatzTimelineReadOnly'
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <PubWrap>
        ...
        {/* Einsatz-Zeitstrahl */}
        <EinsatzTimelineReadOnly
          standort={(p as any).standort}
          einsatzort={(p as any).einsatz_adresse}
          alarmzeit={(p as any).zeit_einsatz}
          zeitStatus3={(p as any).zeit_status3}
          zeitEintreffen={(p as any).zeit_eintreffen}
          zeitUebergabe={(p as any).zeit_uebergabe}
          zeitStatus1={(p as any).zeit_status1}
          zeitStatus2={(p as any).zeit_status2}
        />
