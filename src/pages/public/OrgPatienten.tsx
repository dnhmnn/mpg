...
const STEPS = [
  'Mannschaft','Einsatzdaten','Einsatz-Zeitstrahl','Pat-Stammdaten',
  'Notfallgeschehen / Anamnese','NACA / Bewusstsein','Glasgow Coma Scale',
  'Messwerte / Atmung','Neurologie','Rhythmus / EKG','Haut / Psyche',
  'Erstdiagnose / Diagnose-Kategorien','Verlauf','Verletzungen / Trauma',
  'Atemwege / Lagerung / Immobilisation','Beatmung / Defibrillation',
  'Zugang / Infusion / Medikamente','Reanimation','Übergabe / Besonderheiten','Unterschrift',
]
