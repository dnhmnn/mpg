...
function CalendarButtons({ record }: { record: TokenRecord }) {
  ...
  return (
    <div>
      <div style={{fontSize: '12px', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: '10px'}}>
        Zum Kalender hinzufügen
      </div>
      <div style={{display: 'flex', gap: '8px'}}>
        <a href={googleUrl} target="_blank" rel="noreferrer" style={{...btnBase, background: '#fff', border: '1px solid #e2e8f0', color: '#374151'}}>
        ...
        <button onClick={downloadICS} style={{...btnBase, background: '#fff', border: '1px solid #e2e8f0', color: '#374151'}}>
